...
interface PackagingMaterialsStatsProps {
  total: number;
  lowStock: number;
  totalValue: number;
...
const PackagingMaterialsStats: React.FC<PackagingMaterialsStatsProps> = ({ total, lowStock, totalValue, onStatClick }) => {
...
export default PackagingMaterialsStats;
