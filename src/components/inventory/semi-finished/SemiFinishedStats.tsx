...
interface SemiFinishedStatsProps {
  total: number;
  lowStock: number;
  totalValue: number;
...
const statConfigs = [
  {
    key: 'total',
    icon: Layers,
    label: 'إجمالي المنتجات النصف مصنعة',
...
const SemiFinishedStats: React.FC<SemiFinishedStatsProps> = ({ total, lowStock, totalValue, onStatClick }) => {
...
export default SemiFinishedStats;
