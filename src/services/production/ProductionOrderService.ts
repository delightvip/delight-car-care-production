...
import { ProductionOrder, ProductionStatus } from "./ProductionTypes";

class ProductionOrderService {
  private static instance: ProductionOrderService;
  ...
  public static getInstance(): ProductionOrderService {
    if (!ProductionOrderService.instance) {
      ProductionOrderService.instance = new ProductionOrderService();
    }
    return ProductionOrderService.instance;
  }
  ...
  public async updateProductionOrderStatus(orderId: number, newStatus: ProductionStatus): Promise<boolean> {
    try {
